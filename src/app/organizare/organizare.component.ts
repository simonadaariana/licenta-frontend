...
export class OrganizareComponent implements OnInit {
  ...
  constructor(private router: Router) {}
    ...
    onNextPage(){
      ...
      localStorage.setItem("organizare1", this.valueGroup1.toString())
      localStorage.setItem("organizare2", this.valueGroup2.toString())
      localStorage.setItem("organizare3", this.valueGroup3.toString())
      localStorage.setItem("organizare4", this.valueGroup4.toString())
      // console.log(this.valueGroup1)
      // console.log(this.valueGroup2)
      // console.log(this.valueGroup3)
      // console.log(this.valueGroup4)
      localStorage.setItem("suma_organizare", suma.toString())
      console.log(localStorage.getItem("suma_organizare"))
      localStorage.setItem("organizare", rez.toString())
      console.log(localStorage.getItem("organizare"))
      this.router.navigateByUrl("/tehnologie")
    }
  }
