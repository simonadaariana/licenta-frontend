...
@Component({
  selector: 'app-tehnologie',
  templateUrl: './tehnologie.component.html',
  styleUrls: ['./tehnologie.component.css']
})
export class TehnologieComponent implements OnInit{
  group1: FormGroup;
  group2: FormGroup;
  group3: FormGroup;
  group4: FormGroup;
  ...
  onNextPage(){
    ...
    localStorage.setItem("tehnologie1", this.valueGroup1.toString())
    localStorage.setItem("tehnologie2", this.valueGroup2.toString())
    localStorage.setItem("tehnologie3", this.valueGroup3.toString())
    localStorage.setItem("tehnologie4", this.valueGroup4.toString())
    // console.log(this.valueGroup1)
    // console.log(this.valueGroup2)
    // console.log(this.valueGroup3)
    // console.log(this.valueGroup4)
    localStorage.setItem("suma_tehnologie", suma.toString())
    console.log(localStorage.getItem("suma_tehnologie"))
    localStorage.setItem("tehnologie", rez.toString())
    console.log(localStorage.getItem("tehnologie"))
    this.router.navigateByUrl("/strategie")
  }
}
