...
export class CulturaComponent implements OnInit{
  ...
  onNextPage(){
    ...
    localStorage.setItem("cultura1", this.valueGroup1.toString())
    localStorage.setItem("cultura2", this.valueGroup2.toString())
    localStorage.setItem("cultura3", this.valueGroup3.toString())
    localStorage.setItem("cultura4", this.valueGroup4.toString())
    // console.log(this.valueGroup1)
    // console.log(this.valueGroup2)
    // console.log(this.valueGroup3)
    // console.log(this.valueGroup4)
    localStorage.setItem("suma_cultura", suma.toString())
    console.log(localStorage.getItem("suma_cultura"))
    localStorage.setItem("cultura", rez.toString())
    console.log(localStorage.getItem("cultura"))
    this.router.navigateByUrl("/abilitati")
  }
}
